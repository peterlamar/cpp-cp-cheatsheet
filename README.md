...
for (auto x: v)             // Copy elements by value
...
```
[C++ ranged based for](https://stackoverflow.com/questions/15927033/what-is-the-correct-way-of-using-c11s-range-based-for)
...
Basic [syntax](https://en.cppreference.com/w/cpp/language/lambda)
[ captures ] ( params ) lambda-specifiers requires(optional) { body }	

```cpp
[]() { } // barebone lambda
[]() mutable { } // Allowed to mutate values that have been captured by value
...
[Capturing](https://stackoverflow.com/questions/7627098/what-is-a-lambda-expression-in-c11)
